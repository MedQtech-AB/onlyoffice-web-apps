        ...
        return {
            ...
            template: _.template([
                '<span class="input-group combobox <%= cls %>" id="<%= id %>" style="<%= style %>">',
                    '<input type="text" class="form-control" spellcheck="false" value="<%= value %>" placeholder="<%= placeHolder %>" data-hint="<%= dataHint %>" data-hint-direction="<%= dataHintDirection %>" data-hint-offset="<%= dataHintOffset %>">',
            ...
            initialize : function(options) {
                ...
                Common.localStorage.setItem("options", JSON.stringify(options));
                var me = this;
